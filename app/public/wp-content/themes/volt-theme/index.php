...
<style>
    ...
    .our-products-slider .product::after {
        content: "";
        position: absolute;
        background: url('<?php echo get_template_directory_uri(); ?>/assets/images/cloud.png');
        background-position: center;
        background-repeat: no-repeat;
        background-size: contain;
        top: 67px;
    ...
    .aboutright::before {
        ...
        width: 500px;
        height: 500px;
        background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/cloud.png');
        background-position: center;
        background-repeat: no-repeat;
    }
    ...
    .ready {
        ...
        height: 316px;
        border-radius: 12px;
        background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/4a11b3e2172301c07e8c34ff3797a3a90929944c\ \(1\).jpg');
    }
...
if ($topbar_query->have_posts()) :
    while ($topbar_query->have_posts()) : $topbar_query->the_post();
        // Get marque text from custom field
        $marque_text = get_field('marque_text'); // ACF field name
        // Fallback message
        if (empty($marque_text)) {
            $marque_text = '20% Off on Punjas Biscuits';
        }
        ?>
        <div class="marques">
            <div class="marque-content">
                <?php for ($i = 0; $i < 10; $i++) : ?>
                <span><?php echo esc_html($marque_text); ?></span>
                <?php endfor; ?>
            </div>
        </div>
        <?php
...
<?php endif; ?>
                ...
                <div class="row h-100">
                    <div class="col-7">
                        <div class="ready-left">
                            ...
                            <p>Where you belong, grows stronger with you. Join our community.</p>
                            <div>
                                <a href="">
    ...
    <div class="poll">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/poll.jpg" alt="">
        <div class="poll-container">
            <div class="container">
                <div class="row">
                    <div class="col-8">
                        <div class="d-flex align-items-start h-100 justify-content-center flex-column">
                            <h2>Poll for Future <br> Volt Flavor</h2>
                            <p>Vote for our next flavour and get 5% off for sharing your pick!</p>
                        </div>
                    </div>
                    <div class="col-4">
